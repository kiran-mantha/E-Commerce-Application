...
const Header = () => {
  ...
  return (
    ...
    <section className='flex items-center p-2 gap-2 bg-slate-200 w-[32rem] rounded-md'><CiSearch /><input className='w-full text-lg bg-slate-200' type="text" placeholder="Search for Products, Brands and More" value="" ></input></section>
